// api/injuries.js - שלוף שחקנים פצועים מ-API-Football
...
export default async function handler(req, res) {
  ...
  try {
    // קרא ל-API-Football כדי לקבל שחקנים פצועים
    const response = await fetch(
      'https://api-football-v1.p.rapidapi.com/v3/injuries?season=2025&team=541',
      {
        method: 'GET',
        headers: {
